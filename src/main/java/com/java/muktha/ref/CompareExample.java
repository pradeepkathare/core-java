...
public class CompareExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("s1.compareTo(s2):"+s1.compareTo(s2)); //compares ascii returns 0 for same and  difference between ascii/unicode
...
//eclipse generate setters and getters ,right click select source then generate getter and setter
class Student{
	...
	public boolean equals(Object obj) {
		...
		//example :student1.equals(student2)  :student1 becomes this and student2 is Object passed->case 2
